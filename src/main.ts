...
async function bootstrap() {
  ...
  const corsConfig = {
    origin: process.env.NODE_ENV === 'production'
      ? ['https://bitworld-mmp-fe-production.up.railway.app','https://bitworld-mmp-admin-fe.vercel.app', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3600', 'http://localhost:3700']
